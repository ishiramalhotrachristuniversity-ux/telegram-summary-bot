...
from docx.enum.text import WD_ALIGN_PARAGRAPH # اضافه شده برای راست‌چین کردن
            ...
            if document.get('file_name', '').endswith('.docx'):
                try:
                    ...
                    prompt = (
                        ...
                        "2. تاریخ رویداد حتماً به حروف نوشته شود.\n"
                        ...
                        "6. دستور زبان و نگارش استاندارد فارسی را کاملاً رعایت کن؛ استفاده از «ی» میانجی متصل (مانند: مدرسه‌ی، برنامه‌ی) الزامی است و روی کلماتی که احتمال بدخوانده شدن دارند، حتماً اعراب ضروری (کسره، فتحه، ضمه) را قرار بده.\n\n"
                    ...
                    new_doc = Document()
                    # افزودن پاراگراف و راست‌چین کردن آن
                    paragraph = new_doc.add_paragraph(response.text)
